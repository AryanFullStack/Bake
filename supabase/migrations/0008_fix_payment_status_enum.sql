-- Migration: 0008_fix_payment_status_enum.sql
-- Description: Fixes PL/pgSQL enum type casting in create_guest_order function for payments.status column.
...
-- Overload with public.payment_method parameter signature
create or replace function public.create_guest_order(
  p_customer jsonb, 
