...
export default async function EditDealPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (productsRes.error) {
    console.error("[EditDealPage] Products fetch error:", productsRes.error);
  }
  ...
  return (
    <Suspense fallback={<div className="p-8 text-center text-sm font-bold text-navy">Loading deal editor...</div>}>
      <DealFormClient
